...
@SlingServlet(paths = "/bin/PracticeApp5/QueryBuilderTest1")
public class QueryBuilderTest1 extends SlingSafeMethodsServlet {
    ...
    protected void doGet(final SlingHttpServletRequest request,
        ...
        response.getOutputStream().println(
                "This content is generated by the QueryBuilderTest1");
